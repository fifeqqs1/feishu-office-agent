...
@use "sass:color";
// 全局颜色变量
$primary-start: #ffbc7b;
$primary-end: #ff9f43;
$secondary-start: #ff8c1a;
$secondary-end: #ff9f43;
$accent: #f59e0b;
$success: #10b981;
$warning: #f59e0b;
$error: #ef4444;
...
.task-graph-page {
  ...
  &::before {
    ...
    bottom: 0;
    background-image: 
      linear-gradient(rgba(255, 188, 123, 0.08) 1px, transparent 1px),
      linear-gradient(90deg, rgba(255, 159, 67, 0.08) 1px, transparent 1px);
...
.column {
  ...
  .column-header {
    ...
    .mode-toggle .mode-btn.active {
      background: var(--primary, #ff9f43);
      border-color: var(--primary, #ff9f43);
      color: #fff;
    }
  }
